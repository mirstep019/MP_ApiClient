...
function Home() {
  return (
    <div className='main-pg'>
      <div className='main'>
      <div className='logoTD'>
        <svg width="100" height="100" viewBox="0 0 165 165" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="5" y="5" width="155" height="155" rx="33" fill="white" stroke="#5C16C4" strokeWidth="10"/>
        ...
        <h1>Welcome to Training Diary API</h1>
        <h2>Here you can view, create, edit or delete stuff from <strong>Training Diary Mobile App</strong></h2>
